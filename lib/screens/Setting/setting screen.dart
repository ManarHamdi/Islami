...
import 'package:islami/screens/Setting/theme%20botton%20sheet.dart';
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.stretch,
        ...
        children: [SizedBox(height: 22),
          ...
          Form(child:Column(crossAxisAlignment: CrossAxisAlignment.stretch,children: [
            Container(height: 50,decoration: BoxDecoration(border: Border.all(color: Color(0xffB7935F))),
              child:
         ...
         Text(AppLocalizations.of(context)!.mode,style: Theme.of(context)!.textTheme.titleMedium),
            SizedBox(height: 16,),
           Container(decoration: BoxDecoration(border: Border.all(color: Color(0xffB7935F)),),
    height: 50,child:
